...
import com.sharpdeep.assistant_android.activity.WelcomeActivity;
...
//      gotoLoginActivity(context);
  ...
  private void gotoWelcomeActivity(Context context){
    AndroidUtil.startActivity(context, WelcomeActivity.class);
  }
